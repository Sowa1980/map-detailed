...
Лицензия Открытая для Всех: Раз в год мы отказывается от своих прав и выпускаем спициальный срез с открытыми данными под открытой лиценцией данные будут доступны в полном объеме из нашей базы.
