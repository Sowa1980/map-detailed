Современный аналог карт ген штаба (САКГШ)
...
Часть данных можно затянуть из осм. идеально - хорошо отрисованных мест. но с корректирокой взяли квадрат , скачали из осм. поправили отправили в проект АСГШ
...
Раз в год мы отказывается от своих прав и выпускаем спициальный срез с открытыми данными под открытой лиценцией данные будут доступны в полном объеме из нашей базы.
