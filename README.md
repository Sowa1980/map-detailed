...
7. Участники предоставившем: фото и ортфото планы и видео, GPS треки, данные с личных эхолотов (о промерах глубин), прочие геоданные с точных измерений с приборов такие, как: замеры высот, GPS объектов. лазерное сканирование). - Оплата от продаж данных и контента по факту продажи отчисление проекту с продажи - 25 процентов.
