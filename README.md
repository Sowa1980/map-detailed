...
1. Управляющий - руководящий - буххалтеский - юридический. (отдел) - только денежные выплаты от продаж;
2. Отдел Продаж (любой участник) - только денежные выплаты от продаж;
3. Вкладчики (внесшие деньги на развитие проекта - только денежные выплаты от продаж - начисляется согласно вкладу;
...
5. Участники проекта; (маперы + переводчики +	программистам + дизайнерам + авторам статей)
