...
5. Собственные снимк Орфото планы и, аренда оборудования для получение точных данных. Финансируется за счет Заказчика при выполнение работы. остается как в проекте так и у заказчика (не для перепродажи у проекта) 
