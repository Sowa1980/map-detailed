...
3. Данные о почвах и полезных ископаемых, высот и глубин.
...
1. источники проекта САКГШ - (собственные)
2. Переданные в проект от участников или заказчиков на добровольной основе не для перепродажи.
3. Все открытые данные.
4. Данные с указанием атрибуции и авторства. 
...
внесших вклад данными или оказавшими мат. поддержка или тех ресурсами (отдача на бесплатной основе аналогично и для участников которые в будущем захотят сделать коммерческий проект или использовать в своих ком. целях., но только на последнюю  дату их вклада) Если вам будет нужна более актуальная версия Вам придется или внести свой вклад или купить платную лицензию или воспользоваться Открытой но более старой базой данных.

3. Открытая для всех: 
Раз в 3 или 5 лет мы будем отказывается от всех своих прав и будем выпускаем специальный срез с открытыми данными под открытой лицензией данные будут доступны в полном объеме из нашей базы, но они буут старее ровно на 5 или 3 года чем актуальная версия.

(Выкладываем срез на торрент. данные и бумажные карты.)


# Финансовая организационная сторона:

##  участники по группам:
1. Вкладчики (внесшие деньги на развитие проекта - денежные выплаты от прибыли - начисляется согласно вкладу в процентном соотношение на сумму вклада - (любое лицо или организация);
2. Отдел Продаж (любой участник, любое лицо, организация) - только фиксированный процент от продажи;
3. Управляющий - руководящий, бухгалтерский, юридический(отделы) - фиксированные выплаты по факту оказания услуг;
4. Технический отдел - переводчики +	программистам + дизайнерам + авторам статей) - фиксированные выплаты по факту оказания услуг;
5.1. Аренда оборудования для получение точных данных. Финансируется за счет Заказчика при выполнении работы. остается как в проекте, так и у заказчика (не для перепродажи в проекте) 
6. Участники проекта; (маперы  - только денежные выплаты от продаж согласно участия вклада или возможность обменять на данные в случает отсутствия продаж)
7. Авторы сборщики данных предоставившем: фото и ортфото планы и видео, GPS треки, данные с личных эхолотов (о промерах глубин), прочие геоданные с точных измерений с приборов такие, как: замеры высот, GPS объектов. лазерное сканирование). - Оплата от продаж данных и контента по факту продажи отчисление проекту с продажи - 25 процентов.
8. Заказчики - заказавшие и оплатившие работу для получения того или иного набора данных. Под коммерческой лицензией компании или Частного лица не для перепродажи.

# Техническая основа необходимое:

1. Техническую часть (сервера, сайты) - финансируется за счет средств вкладчиков на первоначальном этапе - дальнейшая окупаемость предоставления доступа компаниям);

2. Геодезическое оборудование - финансируется за счет средств вкладчиков на первоначальном этапе - (окупаемость аренда за счет заказчика, продажа ортфото планов);

3.  Основное Программное обеспечение (1. Blender, должен стать редактором сквозная работа с (база данных-САКГШ). 2. JOSM и так далее с открытым исходным кодом делаем упор на первоначальном этапе дабы исключить дополнительные затраты:


4. Дополнительное Программное обеспечение - финансируется за счет средств вкладчиков, по мере решение об необходимости Руководством. основываясь на запросах участников проекта и окупаемости.

# Окупаемость прибыль:

1. Доступ к серверам компании.
2. Продажа данных-САКГШ
3. Вознаграждение от продажа матерьялов Участников проекта.
4. Аренда геодезического оборудования заказчиками.
5. Реклама.
6. Спонсорская помощь.
7. Партнерские вознограждения за продажу ПО и Геодезического оборудования.
8. Партнерская сеть САКГШ.
9. Продаже полигоафической и прочей продукци географической направленности.

Структура не окончательная.

Каждый участник может входить в любую группу и вносить вклад в ней посильный его силам и знаниям. Чем больше Вы сделаете в любой группе, тем больше Вам будет начислено денежных средств от продаж или в отсутвие продаж Вы сможете скачать более свежие данные. Или же займете более важную ирархическую ступен среди участников.
...
Финансовая и прочие управленческие стороны для участников проекта должны быть прозрачными и открытыми полностью.
...
# Модель сотрудничества и участия в проекте, покупки и заказа данных:
...
# Контактные данные для присоединения к проекту: 
1. тел: 8 902 731 - 34 -58
2. телеграмм: https://t.me/OSM_BelRusUkr
3. скайп: sowa12081980
