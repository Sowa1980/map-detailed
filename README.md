...
6. Участники предоставившем сники (фото и ортфото планы, GPS треки, данные с личных эхолотов )о промерах глубин), замеры высот, прочие гео данные точных измерений с приборов. 
