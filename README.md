...
3. Техническую часть (сервера, сайты) - финансируется за счет средств вкладчиков.;
4. Програмное обеспечение; 
5. Участники проекта; (маперы  - только денежные выплаты от продаж согласно участия вклада или возможность обменять на данные в случает отсутствия продаж)
