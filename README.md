...
1. Управляющий - руководящий - буххалтеский - юридический. (отдел);
2. Отдел Продаж (любой участник);
...
Модель предоставления данных:
1. Вы предоставляете данные только в рамках этого проекта и для этого проекта соглашаетесь со всеми нашими условиями (в последующем получая вознаграждени за свой Авторский труд или за проданный нами Ваш частный материал (орт фото, видео, и так далее) Врамках идля целей проекта последнее не оплачивается. Также вы соглашаетесь не нарушать установленое законодательство данной страны где будет происходить данные действия и размещен контент и базы данных.
